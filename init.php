...
require_once( ANTIBIOTIC__PLUGIN_DIR . 'src/controller.class.php' );
require_once( ANTIBIOTIC__PLUGIN_DIR . 'src/modules.class.php' );
require_once( ANTIBIOTIC__PLUGIN_DIR . 'src/autoload.class.php' );

// Run the autoloader
new ANTIBIOTIC\Autoload;